...
class _FacultySearchState extends State<FacultySearch> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Selector<BaseInfoProv, DataStatus>(
        ...
        builder: (_,status,__){
          switch(status){
            ...
            case DataStatus.failure:
              return ErrorPage(
                onRetry: bProv.getSchoolsFromNet,
              );
                ...
                slivers: [
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    OutlinedButton(
                                      onPressed: ()=>tProv.searchTeachers(false),
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList.builder(
                        itemCount: 1,
                        itemBuilder: (context, index){
                          return Selector<TeacherSearchProv,Tuple2<int,int>>(
                            selector: (_, teacherSearchProv) => Tuple2<int,int>(teacherSearchProv.nowPageInd, teacherSearchProv.pageTotal),
                            shouldRebuild: (prev, next) => prev != next,
                            builder: (_,__,___){
